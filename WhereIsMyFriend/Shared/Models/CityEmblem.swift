...
public struct CityEmblem: Hashable, Sendable {
    ...
    private static let registeredCities: [String: CityEmblem] = [
        ...
        "glasgow": CityEmblem(cityID: "glasgow", displayName: "Glasgow", countryCode: "GB", archetype: .european),
        "liverpool": CityEmblem(cityID: "liverpool", displayName: "Liverpool", countryCode: "GB", archetype: .coastal),
        "frankfurt": CityEmblem(cityID: "frankfurt", displayName: "Frankfurt", countryCode: "DE", archetype: .metropolis),
        "hamburg": CityEmblem(cityID: "hamburg", displayName: "Hamburg", countryCode: "DE", archetype: .coastal),
        "cologne": CityEmblem(cityID: "cologne", displayName: "Cologne", countryCode: "DE", archetype: .european),
        "heidelberg": CityEmblem(cityID: "heidelberg", displayName: "Heidelberg", countryCode: "DE", archetype: .european),
        "marseille": CityEmblem(cityID: "marseille", displayName: "Marseille", countryCode: "FR", archetype: .coastal),
        "lyon": CityEmblem(cityID: "lyon", displayName: "Lyon", countryCode: "FR", archetype: .european),
        "bordeaux": CityEmblem(cityID: "bordeaux", displayName: "Bordeaux", countryCode: "FR", archetype: .european),
        "valencia": CityEmblem(cityID: "valencia", displayName: "Valencia", countryCode: "ES", archetype: .coastal),
        "seville": CityEmblem(cityID: "seville", displayName: "Seville", countryCode: "ES", archetype: .european),
        "porto": CityEmblem(cityID: "porto", displayName: "Porto", countryCode: "PT", archetype: .coastal),
        "brussels": CityEmblem(cityID: "brussels", displayName: "Brussels", countryCode: "BE", archetype: .european),
        "antwerp": CityEmblem(cityID: "antwerp", displayName: "Antwerp", countryCode: "BE", archetype: .coastal),
        "bruges": CityEmblem(cityID: "bruges", displayName: "Bruges", countryCode: "BE", archetype: .european),
        "rotterdam": CityEmblem(cityID: "rotterdam", displayName: "Rotterdam", countryCode: "NL", archetype: .coastal),
        "utrecht": CityEmblem(cityID: "utrecht", displayName: "Utrecht", countryCode: "NL", archetype: .european),
        "basel": CityEmblem(cityID: "basel", displayName: "Basel", countryCode: "CH", archetype: .alpine),
        "lucerne": CityEmblem(cityID: "lucerne", displayName: "Lucerne", countryCode: "CH", archetype: .alpine),
        "warsaw": CityEmblem(cityID: "warsaw", displayName: "Warsaw", countryCode: "PL", archetype: .european),
        "krakow": CityEmblem(cityID: "krakow", displayName: "Krakow", countryCode: "PL", archetype: .european),
        "dubrovnik": CityEmblem(cityID: "dubrovnik", displayName: "Dubrovnik", countryCode: "HR", archetype: .coastal),
        "split": CityEmblem(cityID: "split", displayName: "Split", countryCode: "HR", archetype: .coastal),
        "santorini": CityEmblem(cityID: "santorini", displayName: "Santorini", countryCode: "GR", archetype: .coastal),
        "reykjavik": CityEmblem(cityID: "reykjavik", displayName: "Reykjavik", countryCode: "IS", archetype: .alpine),
        ...
        "santa barbara": CityEmblem(cityID: "santa_barbara", displayName: "Santa Barbara", countryCode: "US", archetype: .coastal),
        "irvine": CityEmblem(cityID: "irvine", displayName: "Irvine", countryCode: "US", archetype: .coastal),
        "boulder": CityEmblem(cityID: "boulder", displayName: "Boulder", countryCode: "US", archetype: .alpine),
        "ann arbor": CityEmblem(cityID: "ann_arbor", displayName: "Ann Arbor", countryCode: "US", archetype: .metropolis),
        "madison": CityEmblem(cityID: "madison", displayName: "Madison", countryCode: "US", archetype: .coastal),
        "durham": CityEmblem(cityID: "durham", displayName: "Durham", countryCode: "US", archetype: .metropolis),
        "chapel hill": CityEmblem(cityID: "chapel_hill", displayName: "Chapel Hill", countryCode: "US", archetype: .metropolis),
        "charlottesville": CityEmblem(cityID: "charlottesville", displayName: "Charlottesville", countryCode: "US", archetype: .european),
        "ithaca": CityEmblem(cityID: "ithaca", displayName: "Ithaca", countryCode: "US", archetype: .alpine),
        "new haven": CityEmblem(cityID: "new_haven", displayName: "New Haven", countryCode: "US", archetype: .european),
        "princeton": CityEmblem(cityID: "princeton", displayName: "Princeton", countryCode: "US", archetype: .european),
        "savannah": CityEmblem(cityID: "savannah", displayName: "Savannah", countryCode: "US", archetype: .coastal),
        "charleston": CityEmblem(cityID: "charleston", displayName: "Charleston", countryCode: "US", archetype: .coastal),
        "asheville": CityEmblem(cityID: "asheville", displayName: "Asheville", countryCode: "US", archetype: .alpine),
        "boise": CityEmblem(cityID: "boise", displayName: "Boise", countryCode: "US", archetype: .alpine),
        "calgary": CityEmblem(cityID: "calgary", displayName: "Calgary", countryCode: "CA", archetype: .alpine),
        "ottawa": CityEmblem(cityID: "ottawa", displayName: "Ottawa", countryCode: "CA", archetype: .european),
        "edmonton": CityEmblem(cityID: "edmonton", displayName: "Edmonton", countryCode: "CA", archetype: .alpine),
        "quebec city": CityEmblem(cityID: "quebec_city", displayName: "Quebec City", countryCode: "CA", archetype: .european),
        "victoria": CityEmblem(cityID: "victoria", displayName: "Victoria", countryCode: "CA", archetype: .coastal),
        "halifax": CityEmblem(cityID: "halifax", displayName: "Halifax", countryCode: "CA", archetype: .coastal),
        "waterloo": CityEmblem(cityID: "waterloo", displayName: "Waterloo", countryCode: "CA", archetype: .metropolis),
        "cancun": CityEmblem(cityID: "cancun", displayName: "Cancún", countryCode: "MX", archetype: .coastal),
        "guadalajara": CityEmblem(cityID: "guadalajara", displayName: "Guadalajara", countryCode: "MX", archetype: .metropolis),
        "monterrey": CityEmblem(cityID: "monterrey", displayName: "Monterrey", countryCode: "MX", archetype: .desert),

        // Asia-Pacific & Middle East Hubs
        "fukuoka": CityEmblem(cityID: "fukuoka", displayName: "Fukuoka", countryCode: "JP", archetype: .coastal),
        "sapporo": CityEmblem(cityID: "sapporo", displayName: "Sapporo", countryCode: "JP", archetype: .alpine),
        "kobe": CityEmblem(cityID: "kobe", displayName: "Kobe", countryCode: "JP", archetype: .coastal),
        "yokohama": CityEmblem(cityID: "yokohama", displayName: "Yokohama", countryCode: "JP", archetype: .coastal),
        "okinawa": CityEmblem(cityID: "okinawa", displayName: "Okinawa", countryCode: "JP", archetype: .coastal),
        "busan": CityEmblem(cityID: "busan", displayName: "Busan", countryCode: "KR", archetype: .coastal),
        "incheon": CityEmblem(cityID: "incheon", displayName: "Incheon", countryCode: "KR", archetype: .coastal),
        "jeju": CityEmblem(cityID: "jeju", displayName: "Jeju", countryCode: "KR", archetype: .coastal),
        "kaohsiung": CityEmblem(cityID: "kaohsiung", displayName: "Kaohsiung", countryCode: "TW", archetype: .coastal),
