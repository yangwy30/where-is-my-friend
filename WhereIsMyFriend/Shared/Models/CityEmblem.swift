...
public struct CityEmblem: Hashable, Sendable {
    ...
    private static let registeredCities: [String: CityEmblem] = [
        ...
        "sydney": CityEmblem(cityID: "sydney", displayName: "Sydney", countryCode: "AU", archetype: .coastal),
        "rome": CityEmblem(cityID: "rome", displayName: "Rome", countryCode: "IT", archetype: .european),
        "berlin": CityEmblem(cityID: "berlin", displayName: "Berlin", countryCode: "DE", archetype: .european),
        "amsterdam": CityEmblem(cityID: "amsterdam", displayName: "Amsterdam", countryCode: "NL", archetype: .european),
        "los angeles": CityEmblem(cityID: "los_angeles", displayName: "Los Angeles", countryCode: "US", archetype: .coastal),
        "chicago": CityEmblem(cityID: "chicago", displayName: "Chicago", countryCode: "US", archetype: .metropolis),
        "seattle": CityEmblem(cityID: "seattle", displayName: "Seattle", countryCode: "US", archetype: .coastal),
